...
- Implemented OAuth: Users can sign in using their Google accounts.
- Authorization
...
```sh
  git clone https://github.com/batoorsohail/auth-app.git
  cd auth-app
```
...
```sh
  ...
  MONGO=(YOUR MONGO Database online link)
...
Feel free to check the [issues page](https://github.com/batoorsohail/auth-app/blob/dev/LICENSE).
